...
(function($){
	...
	$.extend({
		DirtyForms: {
			debug : false,
			message : 'Sie haben nicht gespeicherte Änderungen in einem Formular. Möchten Sie trotzdem fortfahren?',
			title : 'Warnung!',
			dirtyClass : 'dirty',
	...
	$.fn.setDirty = function(){
		...
		return this.each(function(e){
			...
			$(this).addClass($.DirtyForms.dirtyClass).parents().addClass($.DirtyForms.dirtyClass);
			$('#globalDirtyFlag').show();
		});
	}
